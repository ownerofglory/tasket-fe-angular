import { Directive, Input, Output, ElementRef, OnInit, OnDestroy, Renderer2, EventEmitter } from '@angular/core';
...
export class DroppableDirective implements OnInit, OnDestroy {
  ...
  // Drop Event Emitter
  @Output() public onDroppableComplete: EventEmitter<any> = new EventEmitter();
